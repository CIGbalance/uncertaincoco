\hypertarget{classUncertainFunc__m}{}\section{Uncertain\+Func\+\_\+m Class Reference}
\label{classUncertainFunc__m}\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
...
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!cheater\+\_\+eval@{cheater\+\_\+eval}}
\index{cheater\+\_\+eval@{cheater\+\_\+eval}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{cheater\+\_\+eval(\+Real\+Vector point) const}{cheater_eval(RealVector point) const}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf double}$\ast$ {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$\+::cheater\+\_\+eval (
...
function value 
\end{DoxyReturn}
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!eval@{eval}}
\index{eval@{eval}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{eval(\+Real\+Vector point) const}{eval(RealVector point) const}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf double}$\ast$ {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$\+::eval (
\begin{DoxyParamCaption}
\item[{Real\+Vector}]{point}
\end{DoxyParamCaption}
...
function value 
\end{DoxyReturn}
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!init@{init}}
\index{init@{init}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{init(const C\+O\+C\+Ofunc$<$ Multi\+Objective\+Function $>$ $\ast$f1, int k, int h, double uncertainty\+Threshold, double history\+Threshold, Sample\+Mode samp, int min\+K=-\/1)}{init(const COCOfunc< MultiObjectiveFunction > *f1, int k, int h, double uncertaintyThreshold, double historyThreshold, SampleMode samp, int minK=-1)}}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf Uncertain\+Func}$<$ Multi\+Objective\+Function  $>$\+::init (
\begin{DoxyParamCaption}
\item[{const {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$ $\ast$}]{f1, }
\item[{{\bf int}}]{k, }
\item[{{\bf int}}]{h, }
...
\hline
\end{DoxyParams}
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!in\+Region\+Of\+Interest@{in\+Region\+Of\+Interest}}
\index{in\+Region\+Of\+Interest@{in\+Region\+Of\+Interest}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{in\+Region\+Of\+Interest(\+Real\+Vector const \&input) const}{inRegionOfInterest(RealVector const &input) const}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$\+::in\+Region\+Of\+Interest (
\begin{DoxyParamCaption}
...
\end{DoxyReturn}
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!is\+Feasible@{is\+Feasible}}
\index{is\+Feasible@{is\+Feasible}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{is\+Feasible(\+Real\+Vector const \&input) const}{isFeasible(RealVector const &input) const}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf bool} {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$\+::is\+Feasible (
\begin{DoxyParamCaption}
\item[{Real\+Vector const \&}]{input}
\end{DoxyParamCaption}
...
\end{DoxyReturn}
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!lhs@{lhs}}
\index{lhs@{lhs}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{lhs(int point\+\_\+num, int seed, int duplication=5) const}{lhs(int point_num, int seed, int duplication=5) const}}]{\setlength{\rightskip}{0pt plus 5cm}Archive\+Data {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$\+::lhs (
\begin{DoxyParamCaption}
...
\end{DoxyReturn}
\index{Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}!lhs\+Sample@{lhs\+Sample}}
\index{lhs\+Sample@{lhs\+Sample}!Uncertain\+Func\+\_\+m@{Uncertain\+Func\+\_\+m}}
\subsubsection[{\texorpdfstring{lhs\+Sample(int point\+\_\+num, int seed, int duplication=5) const}{lhsSample(int point_num, int seed, int duplication=5) const}}]{\setlength{\rightskip}{0pt plus 5cm}std\+::vector$<$Real\+Vector$>$ {\bf C\+O\+C\+Ofunc}$<$ Multi\+Objective\+Function  $>$\+::lhs\+Sample (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{point\+\_\+num, }
\item[{{\bf int}}]{seed, }
\item[{{\bf int}}]{duplication = {\ttfamily 5}}
